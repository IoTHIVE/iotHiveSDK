Getting Started with Contiki for HiveMotes
==========================================

This is a quick guide's to help you start using Contiki with hiveMotes.

hiveMote IoT platform has following features
============================================
* Deep Sleep support with RAM retention for ultra-low energy consumption.

* Base boards Peripherals
  - LED x2
  - USER BUTTON x1
  - SD CARD - for FOTA and other storage
  - BSL Support over USB(FTDI)
  - ARDUINO SHIELD SUPPORT - for feature expansion
  - CURRENT SENSOR
  - 
